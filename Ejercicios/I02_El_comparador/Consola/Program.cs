...
namespace Consola
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Punto 3
            Comparar(primerTexto, segundoTexto, (txt1, txt2) => ContarCaracteres(txt1, new List<char> { ' ' }) - ContarCaracteres(txt2, new List<char> { ' ' }));
        ...
        public static void Comparar(string texto1, string texto2, Func<string, string, int> criterioDeComparacion)
        {
            if (criterioDeComparacion(texto1, texto2) > 0)
            {
                Console.Write("El primero"); 
            }
            else if (criterioDeComparacion(texto1, texto2) < 0)
            {
                Console.Write("El segundo");
            }
            else
            {
