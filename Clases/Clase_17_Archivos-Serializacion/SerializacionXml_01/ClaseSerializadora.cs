    ...
    public class ClaseSerializadora
    {
        ...
        public static void Escribir(Personaje pj)
        {
            ...
            try
            {
                ...
                {
                    XmlSerializer xmlSerializer = new XmlSerializer(typeof(Personaje)); // Le paso el tipo de objeto a serializar.
                ...
                if (Directory.Exists(path))
                {
                    ...
                    if (archivo != null)
                    {
                        using (StreamReader sr = new StreamReader(archivo))
                        {
                            ...
                            pj = (Personaje)xmlSerializer.Deserialize(sr); // Casteo al tipo que corresponda la deserealización.
                        }
                    }
                }
